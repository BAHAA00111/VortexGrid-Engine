"""
Core Distributed Context Manager
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
Provides rank topology auto-detection, NCCL process group lifecycle management,
GPU assignment isolation, and collective barrier primitives for distributed training.
"""
...
class DistributedConfig:
    ...
    find_unused_parameters: bool = field(
        default_factory=lambda: os.getenv("VORTEXGRID_FIND_UNUSED_PARAMS", "0").lower()
        in ("1", "true", "yes")
    )
